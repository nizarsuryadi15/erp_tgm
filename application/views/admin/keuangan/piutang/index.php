<div class="row p-4">
    <div class="card">
        <div class="card-header">
            Total Piutang : Rp. <?= number_format($total_trx['total_piutang']) ?>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-hover mb-0" id="datatable-details">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url($controller.'/detail_piutang/'.$dt->konsumen_id) ?>" class="btn btn-outline-secondary btn-sm">Detail</a>
                            </td>
                        </tr>
                        <?php 
                        $no++;
