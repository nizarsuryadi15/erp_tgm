                                        ...
                                        <td class="text-left">
                                            ...
                                            <?php 
                                                foreach ($edc as $key => $value) {
                                                    $total_debit = $this->db->query("SELECT SUM(bayar_debit) as total_debit FROM tbl_pembayaran 
                                                                                        WHERE id_edc = '$value->edc_id' AND pembayaran_tgl 
                                                                                            like'$bulanini%' ")->row_array();
                                                    ...
                                                    if ($total_debit['total_debit'] != 0) 
                                                    {
                                                        ...
                                                        <?php
                                                        echo "<td class='text-end'>".number_format($total_debit['total_debit'])."</td>";
                                                        echo "</tr>";
                                                    }
