                            ...
                            <table class="table table-bordered">
                                ...
                                <?php 
                                    ...
                                    foreach ($kategori as $key => $value) {
                                        $total_pengeluaran = $this->db->query("SELECT SUM(pengeluaran_jumlah) as total_pengeluaran FROM tbl_pengeluaran_bulanan WHERE kategori_pengeluaran_id = '$value->id' AND pengeluaran_bulan = '$bulanini' AND pengeluaran_tahun = '$tahunini'  ")->row_array();
...
<form action="<?= base_url('keuangan/add_pengeluaran_bulanan')?>" method="post">
<section class="panel">
    <header class="panel-heading">
        <h2 class="panel-title">Tambah Pengeluaran Bulanan</h2>
    </header>
    <div class="panel-body">
