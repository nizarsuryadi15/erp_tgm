            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input name="alur_id" type="text" class="form-control" id="inputDefault" value ="<?= $id['alur_id']  ?>" readonly>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="inputDisabled">Urutan Alur</label>
                        <div class="col-md-6">
                            <input name="alur_urutan" class="form-control" id="alur_urutan" type="text" autofocus>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="inputDisabled">Nama Alur</label>
                        <div class="col-md-6">
                            <input name="alur_nama" class="form-control" id="alur_nama" type="text" >
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="inputDisabled">Keterangan</label>
                        <div class="col-md-6">
                            <textarea name="alur_keterangan" class="form-control" id="alur_keterangan"></textarea>
                        </div>
                    </div>
