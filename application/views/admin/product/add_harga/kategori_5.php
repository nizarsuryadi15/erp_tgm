<table class="table">
    ...
    <form action="<?= base_url('manufaktur/action_save_all')?>" method="post">
        ...
        <tr>
            <td>
                <input type="hidden" class="form-control" name="segmen2" value="<?= $segmen2 ?>">
            ...
            <td>
                <select name="ket_1[]" id="ket_1" class="form-control">
                    ...
                    <?php foreach ($lebarkain as $value): ?>
                        <option value="<?= $value->id ?>" <?= $value->id == $hrg->ket_1 ? 'selected' : '' ?>>
                            <?= $value->lebar_textile ?>
                        </option>
                    <?php endforeach; ?>
                </select>
