                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                            <div class="mb-md">
                                <a href="<?= base_url($controller.'/tambah-jabatan')?>" class="btn btn-primary">Tambah Jabatan / Divisi <i class="fa fa-plus"></i></a>
                        ...
                        <tbody>
                            ...
                            <tr >
                                ...
                                <td class="actions text-center" >
                                    <a href="<?= base_url($controller.'/viewData/'.$dt->divisi_nama)?>" class="btn btn-success"><i class="fa fa-list"></i></a>
