...
<!-- <meta http-equiv='refresh' content='0.2;<?= base_url('Penjualan') ?>'> -->
...
<table class='bayar'>
    <tr><td rowspan="6" width="40%"></td><td colspan="4">Total</td><td align="right"><?= number_format(@$pembayaran['sub_total'], 0, ".", ".") ?></td></tr>
