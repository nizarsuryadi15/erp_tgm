       ...
       public function search_konsumen()
        {
            ...
            $this->db->select('konsumen_id, konsumen_nama, konsumen_nohp');
            $this->db->from('tbl_konsumen');
            $this->db->group_start();
                $this->db->like('LOWER(konsumen_nama)', strtolower($term));
                $this->db->or_like('konsumen_nohp', $term); // nomor tidak perlu strtolower
            $this->db->group_end();
        ...
        public function load_transaksi($nospk)
        {
            ...
            $this->load->view('admin/transaksi/tmp_body', $data);
        }
        ...
        public function action_add_temp(){
            ...
            if (!empty($inputs['ket_1']) && $inputs['ket_1'] == 2) {
                $hargaQuery = $this->M_transaksi->cekHargaProductB($inputs['product'], $inputs['qty'], $inputs['ket_1']);
                // echo "kesini";
            
            }elseif ($inputs['jenisprint_id']){
                // echo "kesini 2";
                $hargaQuery = $this->M_transaksi->cekHargaKategori2($inputs['product'], $inputs['jenisprint_id']);
            } 
            else {
        ...
        public function add_pemesanan(){
            ...
            if ($cekTransaksi) {
                ...
                redirect('transaksi/createspk/' . $nospk);
            } else {
                // Insert baru
                ...
                $this->session->set_flashdata('success', 'Pemesanan berhasil dikirim ke kasir.');
                redirect('transaksi/transaksi_deskprint');
            }
        ...
        function transaksi_deskprint(){
            ...
            $this->load->view('layout_admin/sidebar', $data);
            $this->load->view('admin/transaksi/transaksi_deskprint', $data);
            $this->load->view('layout_admin/footer');
        ...
        function spk_baru(){
            ...
            $this->load->view('admin/transaksi/spk_baru', $data);
            $this->load->view('layout_admin/footer');
        }
        ...
        function createspk(){
            ...
            $data = [
                ...
                // print_r($data['getproduk']);
            // Tampilkan view
            $this->load->view('layout_admin/head', $data);
            $this->load->view('layout_admin/top_header');
            $this->load->view('layout_admin/sidebar');
            $this->load->view('admin/transaksi/createspk', $data);
            $this->load->view('layout_admin/footer');
